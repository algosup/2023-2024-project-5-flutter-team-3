...
class JobSeekerMessageList extends StatefulWidget {
  JobSeekerMessageList({super.key});

  @override
  State<JobSeekerMessageList> createState() => _JobSeekerMessageListState();
}

class _JobSeekerMessageListState extends State<JobSeekerMessageList> {
